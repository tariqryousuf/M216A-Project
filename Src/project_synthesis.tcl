...
analyze -format verilog {pix_mem.v}
analyze -format verilog {maxSelector.v}
analyze -format verilog {FixedPointAdder.v}
analyze -format verilog {mux_784_in.v}
analyze -format verilog {accumulator.v}
analyze -format verilog {mod_N_counter.v}
